    ...
    ui(new Ui::ClientWidget)
{
    ...
    ui->lineEditIP->setText(t_xml.getIp());
    qDebug()<<"t_xml.getIp:"<<t_xml.getIp();

    QString t_xmlPort = QString::number(t_xml.getPort(),10);
    ui->lineEditPort->setText(t_xmlPort);
    qDebug()<<"t_xml.getPort:"<<t_xml.getPort();
