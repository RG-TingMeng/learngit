    ...
    if(sizeof(t_person->getDateLength()) >= 4 )
    {
        ...
        if(t_person->getDateLength() == sizeofAllDate)
        {
            if(t_person->getComboBoxIndex()==0)
            {
                ...
                ui->tableWidgetStu->setItem(t_countStuRow,1,new QTableWidgetItem(t_person->getAge()));
            ...
            else
            {
                ...
                ui->tableWidgetPro->setItem(t_countProRow,1,new QTableWidgetItem(t_person->getAge()));
                const Person t_per = *t_person;
...
void ServerWidget::on_btnTurnUp_clicked()
{
    ...
    if(ui->tabWidget->currentIndex()==0)
    {
        ...
        for(int i=t_currStuPage;i<t_currStuPage+5;i++)
        {
            ...
            ui->tableWidgetStu->setItem(t_stuR,1,new QTableWidgetItem(t_stuList.at(i).getAge()));
            t_stuR++;
        }
    }else
    {
        ...
        for(int i=t_currProPage;i<t_currProPage+5;i++)
        {
            ...
            ui->tableWidgetPro->setItem(t_proR,1,new QTableWidgetItem(t_proList.at(i).getAge()));
            t_proR++;
        }
    }
}
